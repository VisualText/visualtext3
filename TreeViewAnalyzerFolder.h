...
class CTreeViewAnalyzer : public CXTTreeCtrl
{
protected:
...
public:
	...
	void EditRulesFile(LPCTSTR lpRulesPath = NULL);
...
private:
	...
	void UpdateKB();
	int CalculatePassNumber(CONCEPT *concept, bool skipFoldersFlag=true);
