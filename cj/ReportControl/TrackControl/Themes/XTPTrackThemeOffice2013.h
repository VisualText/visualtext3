// XTPTrackThemeOffice2013.h: interface for the CXTPTrackPaintManager class.
//
...
#if !defined(__XTPTRACKTHEMEOffice2013_H__)
#define __XTPTRACKTHEMEOffice2013_H__
//}}AFX_CODEJOCK_PRIVATE
...
//===========================================================================
// Summary:
//     CXTPTrackThemeOffice2013 is a CXTPTrackPaintManager derived
//     class.  This represents an Office 2013 style theme.
//===========================================================================
class _XTP_EXT_CLASS CXTPTrackThemeOffice2013 : public CXTPTrackPaintManager
{
public:
	//-----------------------------------------------------------------------
	// Summary:
...
#endif //#if !defined(__XTPTRACKTHEMEOffice2013_H__)
