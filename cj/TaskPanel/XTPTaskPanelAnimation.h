// XTPTaskPanelAnimation.h: interface for the CXTPTaskPanelAnimation class.
//
...
#if !defined(__XTPTASKPANELANIMATION_H__)
#define __XTPTASKPANELANIMATION_H__
//}}AFX_CODEJOCK_PRIVATE
...
class _XTP_EXT_CLASS CXTPTaskPanelAnimation
{
protected:
	struct CAnimateInfo
	{
...
public:
	CXTPTaskPanelAnimation(CXTPTaskPanel* pTaskPanel);
	~CXTPTaskPanelAnimation();
...
#endif // !defined(__XTPTASKPANELANIMATION_H__)
