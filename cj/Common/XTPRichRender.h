// XTPRichRender.h: interface for the CXTPRichRender class.
//
...
#if !defined(__XTPRICHRENDER_H__)
#define __XTPRICHRENDER_H__
//}}AFX_CODEJOCK_PRIVATE
...
//#ifdef WIN95_IME
	virtual XTP_HIMC        TxImmGetContext() = 0;
	virtual void        TxImmReleaseContext( XTP_HIMC himc ) = 0;
//#endif
...
class _XTP_EXT_CLASS CXTPRichRender : public CCmdTarget
{
public:
	CXTPRichRender();
	~CXTPRichRender();
	...
	void DrawText(CDC* pDC, LPCRECT lpRect);
...
AFX_INLINE ITextServices* CXTPRichRender::GetTextService() const {
	return m_pTextService;
}

#endif // !defined(__XTPRICHRENDER_H__)
