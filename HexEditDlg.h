...
class CHexEditDlg : public CXTPResizeDialog
{
// Construction
public:
...
// Dialog Data
	...
	CXTPColorPicker	m_cpTextHiliteDisabled;
	CXTPColorPicker	m_cpBackHiliteDisabled;
	CXTPColorPicker	m_cpTextEnabledDisabled;
	CXTPColorPicker	m_cpBackEnabledDisabled;
	CXTPColorPicker	m_cpTextHiliteEnabled;
	CXTPColorPicker	m_cpBackHiliteEnabled;
	CXTPColorPicker	m_cpTextEnabled;
	CXTPColorPicker	m_cpBackEnabled;
	CXTPMaskEdit	m_editBaseAddress;
...
public:
	void SetData(LPBYTE buf, int len);
	void SetOptions(BOOL a, BOOL h, BOOL c, BOOL w);
	void SetFileData(CString fileNamePathStr);
};
